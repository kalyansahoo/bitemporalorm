...
class CreateFieldTables(Operation):
    ...
    def to_sql(self) -> str:
        ...
        parts.append(f'CREATE INDEX IF NOT EXISTS ON "{audit_table}" USING GIST ("entity_id", "as_of");')
        ...
        parts.append(f'CREATE INDEX IF NOT EXISTS ON "{mat_table}" USING GIST ("entity_id", "as_of");')
...
class DropFieldTables(Operation):
    ...
    def to_sql(self) -> str:
        ...
        return (
            f'DROP TABLE IF EXISTS "{audit}" CASCADE;\n'
            f'DROP TABLE IF EXISTS "{mat}" CASCADE;'
        )
